#!/usr/bin/env python3
"""
Add Flynn Gold / Forrestania Hub consolidation announcement to the timeline map.

Announcement: 25 February 2026 — Forrestania Further Consolidates Forrestania Hub
Tenements acquired: E77/2915, E63/2187, E63/2188, E63/2190 + Applications E63/2408, E63/2414
Counterparty: Flynn Gold Limited
Consideration: $350,000 in FRS shares at $0.5457 per share
"""
...
FLYNN_GOLD_IDS = [
    ...
    "E63/2188",
    "E63/2190",
    "E63/2408",   # Application
    "E63/2414",   # Application
]

ALL_NEW_IDS = set(FLYNN_GOLD_IDS)
...
# ── Step 3: Create new Flynn Gold event ──
print("\nStep 3: Creating Flynn Gold event...")
...
flynn_event = {
    ...
    "title": "Forrestania Hub consolidation — 6 ELs acquired from Flynn Gold Limited",
    "strategic_impact": (
        "Binding HoA to acquire four granted Exploration Licences (E77/2915, E63/2187, E63/2188, "
        "E63/2190) and two Applications (E63/2408, E63/2414) from Flynn Gold Limited for $350K in "
        "FRS shares at $0.5457/share. Located on the southern extension of the Archaean Southern Cross "
        "Belt within the Forrestania Hub — adjacent to the Bounty deposit (1Moz+) and proximal to "
        "the wholly-owned Lake Johnston 1.5Mtpa processing plant. Continues the disciplined tenure "
        "consolidation strategy around existing granted mining tenure while preserving cash for "
        "near-term production development."
    ),
    "tenement_ids": FLYNN_GOLD_IDS,
    "missing_ids": [],
    "new_ids": FLYNN_GOLD_IDS,
    "tenements_added_story": len(FLYNN_GOLD_IDS),
    "counterparties": "Flynn Gold Limited",
    "consideration": "$350K in FRS shares @ $0.5457/share",
    "project": "Forrestania Hub",
    "confidence": "high",
...
print(f"\nDone! Flynn Gold event added as step {new_idx + 1}/{len(events)}")
